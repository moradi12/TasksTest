package exam1.example.demo2.Advice;
...
public class AdviceD {

    @ExceptionHandler(value = {PersonException.class, TaskException.class})
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrDetails handleTaskException(RuntimeException e) {
